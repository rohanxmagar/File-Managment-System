<style>
        ...
        .container1 {
            ...
            padding: 50px 10px; /* Adds padding to the container */
    ...
    <p>Manage students, view profile, track performance</p>

    <div class="container1">
        <!-- Affiliation & Approval Box -->
        <a href="#" >
            <div class="card option-box1" data-page="./manage_students.php">
                <img src="./content/student.png" alt="student icon" height="75px">
                <p>Manage Students</p>
            </div>
        </a>
        ...
        <a href="#" >
            <div class="card option-box1" data-page="./examination.php">
                <img src="./content/profile.png" alt="profile icon" height="75px">
                <p>View Profile</p>
            </div>
        </a>
        <a href="#" >
            <div class="card option-box1" data-page="./examination.php">
                <img src="./content/performance.png" alt="performance icon" height="75px">
